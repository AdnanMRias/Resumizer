...
GOOGLE_CLIENT_ID = "667578542901-6946l9bu7ujdhgm8rl90j7riauq0o8v5.apps.googleusercontent.com"
        ...
        try:
            ...
            if file and allowedExtension(file.filename):
                ...
                result = resumeFetchedData.insert_one({
                    ...
                    "Name": fetchedData[0],
                    "Mobile_no": fetchedData[1],
                    "Email": fetchedData[2],
                    "Skills": list(fetchedData[3]),
                    "Education": fetchedData[4],
                    "Appear": 0,
                    "ResumeTitle": filename,
                    "ResumeData": fetchedData[5]
                })
                ...
                if result:
                    ...
                    if result1:
                        return render_template("EmployeeDashboard.html", successMsg="Resume Screen Successful!!")
                    else:
            ...
            return render_template("EmployeeDashboard.html", errorMsg="No file uploaded")
        
        except Exception as e:
            print("Exception Occurred:", e)
            return render_template("EmployeeDashboard.html", errorMsg="An error occurred while processing the resume")
